...
public class SendMailServlet extends HttpServlet {
	...
	public SendMailServlet() {
		try {
			...
			String filePath = MemberDAO.class.getResource("/com/scy/todo/member/confidential/confidential.xml").getPath();
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String fromMail = prop.getProperty("mailAddr");
		String fromUserName = prop.getProperty("userName");
		String toMail = mail;

		final String smtpEmail = prop.getProperty("mailAddr");
