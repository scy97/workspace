		...
		<section class="content">
			<section class="content-1">
				...
				<form action="input" method="post" id="inputData">
					이메일 : <input type="email" name="email" required> 패스워드 : <input
						type="password" name="inputPw" required> 닉네임 : <input
						type="text" name="nickname" required> 전화번호 : <input
						type="number" name="phone" required> 주소 : <input
						type="text" name="addr" required>
